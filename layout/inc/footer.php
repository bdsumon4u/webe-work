<footer id="page-footer" class="flex items-center flex-none py-5">
    <div class="container flex flex-col px-4 mx-auto text-sm text-center md:flex-row md:justify-between md:text-left lg:px-8 xl:max-w-7xl">
        ...
        <div class="inline-flex items-center justify-center pt-1 pb-4 md:pt-4">
            ...
            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4 mx-1 text-red-600 hi-solid hi-heart">
                <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"></path>
            </svg>
            <span>
                by
                <a href="javascript:void(0)" class="font-medium text-violet-600 hover:text-violet-400" target="_blank">HotashTech</a></span>
        </div>
    </div>
</footer>
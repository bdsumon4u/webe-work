...
<div class="flex flex-col bg-white border rounded-lg md:col-span-3">
    <div class="flex flex-col items-center justify-between gap-4 p-5 text-center border-b border-slate-100 sm:flex-row sm:text-left">
        <div>
            <h2 class="mb-0.5 font-semibold">Movie List&nbsp;:&nbsp;<span>[<?= count($movies) ?>]</span></h2>
        </div>
        <div>
            <a href="/movies/add.php" class="inline-flex items-center justify-center px-3 py-2 space-x-2 text-sm font-semibold leading-5 bg-white border rounded-lg border-slate-200 text-slate-800 hover:border-violet-300 hover:text-violet-800 active:border-slate-200">
                Add New Movie
            </a>
        </div>
    </div>
                        ...
                        <tr class="border-b border-slate-100">
                            ...
                            <td class="py-3 pl-3 font-medium text-right">
                                <form action="/delete.php" method="POST">
                                    <a href="/movies/edit.php?index=<?= $index ?>" class="group inline-flex items-center gap-1 rounded-lg border border-slate-200 px-2.5 py-1.5 font-medium text-slate-800 hover:border-violet-300 hover:text-violet-800 active:border-slate-200">
                                        <span>Edit</span>
